...
struct AppSettings {
    ...
    static let defaultPortalURLString: String = getAgsSetting(named: "DefaultPortalURLString") ?? arcGISOnlineURLString
    
    // URL String to ArcGIS Online
    static let arcGISOnlineURLString: String = "https://www.arcgis.com"
